...
import { Search, MoreVertical, Calendar, ChevronDown, ArrowLeft } from "lucide-react"
  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="bg-white p-4 flex items-center justify-between border-b">
        ...
        <div className="flex items-center">
          <Button variant="ghost" size="sm" onClick={onBackClick} className="mr-4 flex items-center">
          ...
          <Input
            ...
            placeholder="Search"
            className="w-64 mr-4"
            prefix={<Search className="h-4 w-4 text-neutral-50" />}
          />
      ...
      <div className="flex flex-1 overflow-hidden">
        <LeftMenu activePage="estimates" onNavigate={handleMenuNavigation} />

        <div className="flex-1 p-6 overflow-y-auto">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">Manage estimates</h2>
            <Button onClick={() => onCreateClick()} className="bg-black hover:bg-neutral-90 text-white">
              Create new estimate
            </Button>
          </div>
          ...
          <div className="border rounded-md overflow-hidden">
            <table className="w-full">
              ...
              <tbody>
                <tr className="bg-[#F3F9FF] border-b cursor-pointer hover:bg-[#E3F2FD]" onClick={onEstimateClick}>
