"use client"
import { BarChart2, Layers, Users, FileText, Package, Calendar, Activity, Settings } from "lucide-react"
...
export default function LeftMenu({ activePage, onNavigate }: LeftMenuProps) {
  const menuItems = [
    {
      section: null,
      items: [
    ...
    {
      section: "Inventory",
      items: [{ id: "inventory", label: "Inventory Management", icon: Package }],
    },
  ]

  return (
    <div className="w-[280px] min-w-[280px] bg-neutral-100 p-4 overflow-y-auto">
